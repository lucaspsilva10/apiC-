...
namespace APIEstudo.Domain.Entities
{
    public class Usuario
    {
        ...
        public Usuario( string nome, string cpf, string email, string senha) 
        {
            ...
            if (!cpfValido) throw new ArgumentException(cpfmensagem);

            var (emailValido, emailMensagem) = EmailValidation(email);
            if (!emailValido) throw new ArgumentException(emailMensagem);
        ...
        private static (bool valido, string mensagem) EmailValidation(string email)
        {
